...
\begin{figure}[tb]\begin{center}
	\subfigure{\label{fig:jetshapes}
  	\includegraphics[width=0.47\textwidth]{objectsreconstruction/figures/jetshapes}}
        \subfigure{\label{fig:corr_jet}
        \includegraphics[width=0.5\textwidth]{objectsreconstruction/figures/corr_jet.eps}}
...
\begin{figure}[tb]\begin{center}
	...
	\caption{these values refer to jets with $\pt >15\gev$ and 
