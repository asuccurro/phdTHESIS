...
Some difficulties arise when dealing with $\pi^0$ and $\eta$ particles, 
...
algorithm with a radius parameter $R=0.4$ (from 
which the algorithm is often referred to as anti-$k_t$4) 
using calorimeter energy deposits corrected for effects 
