...
quarks~\cite{Frampton:1999xi,AguilarSaavedra:2009es} %,Martin:2009bg}
...
%The fact that these new quarks decouple 
%from Higgs production and decay 
%processes allows to by-pass then the
%limitations encountered by a fourth chiral 
...
\myskip
	\subfigure{ %\label{fig:vlqxsec8tev}
  	\includegraphics[width=0.7\textwidth]{theory/juanantonio/1306.0572v3_FILES/fig4a}}
