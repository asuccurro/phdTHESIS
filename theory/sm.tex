...
\end{equation}
where $\sigma_{i}$ are the Pauli matrices, the letf- and right-handed spinors transform as:
\begin{align}
&\left \{ \begin{array}{ll}
...
and to a scalar Higgs boson:\begin{equation}\label{eq:higgsDoub}
