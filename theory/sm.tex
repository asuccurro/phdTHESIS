...
\begin{figure}[htb]\begin{center}
	...
	\subfigure[]{\label{fig:WtopMass}
  	\includegraphics[width=0.6\textwidth]{theory/figures/W_vs_top.eps}}
        \caption[bla]{(a) \input{theory/figures/fitSM_new.tex}
        (b) \input{theory/figures/W_vs_top.tex}}
...
Figure~\ref{fig:history_mt} shows how the 
~\cite{Wicke:2010cg}
...
\includegraphics[width=0.4\textwidth]{theory/figures/TevMtWin13-2digit}}
\caption{(a) Comparison of direct
...
the discovery of the top quark~\cite{ALEPH:2005ab}. (b) ~\cite{CDF:2013jga}}
\end{center}
\end{figure}
