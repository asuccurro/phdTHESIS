...
\begin{figure}[htb]\begin{center}
	...
	\caption{Shape-dependent systematic uncertainty from JESBREAK1 for \label{fig:jesHTX}}
\end{center}\end{figure}
...
This uncertainty is referred to as ``$\mathbf{Q_{fac}}$''.
...
partons.  
This uncertainty, referred to as ``$\mathbf{k_{Tfac}}$'',
