...
Assuming a SM Higgs boson with a mass of  $m_H= 125~\gev$,
...
\input{htx_analysis_14ifb/tables/LatexTable_yields_ELEMUON_noEff.tex}
...
\input{htx_analysis_14ifb/tables/LatexTable_acceptance_x_efficiency_ELEMUON_6jetin2btagex.tex}
...
%\begin{table}
\begin{center}%\footnotesize
\input{htx_analysis_14ifb/tables/LatexTable_acceptance_x_efficiency_ELEMUON_6jetin3btagex.tex}
...
%\begin{table}
\begin{center}%\footnotesize
\input{htx_analysis_14ifb/tables/LatexTable_acceptance_x_efficiency_ELEMUON_6jetin4btagin.tex}
...
\includegraphics[width=0.45\textwidth]{htx_analysis_14ifb/figures/doubletcomp_HTAll_ELEMUON_6jetin3btagex_NOMINAL.eps}}
\subfigure[]{\label{fig:singletdoublet_4b}
\includegraphics[width=0.45\textwidth]{htx_analysis_14ifb/figures/doubletcomp_HTAll_ELEMUON_6jetin4btagin_NOMINAL.eps}}
\caption{
...
\input{htx_analysis_14ifb/figures/htxcontrolregions.tex}
...
\begin{figure}[htb]\begin{center}
	\subfigure[]{
  	\includegraphics[width=0.45\textwidth]{htx_analysis_14ifb/figures/shapesys/6jetin4btagin_ELEMUON_ttbar-HF_JESBREAK1.eps}}
	\subfigure[]{
  	\includegraphics[width=0.45\textwidth]{htx_analysis_14ifb/figures/shapesys/6jetin4btagin_ELEMUON_ttbar-Light_JESBREAK1.eps}}
...
\caption{Summary of the overall normalization uncertainties (in \%) considered in the analysis,in the case of the 
\chiv\ channel, for signal and backgrounds.
These uncertainties are before the fit of the $t\bar{t}$ background normalization to data is performed. \label{tab:htxSYS4b} }
\end{center}
\end{table}
...
\input{htx_analysis_14ifb/fullprofiling.tex}
...
almost a factor of two. This is due to a suboptimal
...
which needs to be improved for analyses such as this one involving
high \bjet\ multiplicities. Recent analyses are using \btag\ 
