...
focuses on \B\  (\T) decay channels where at least one 
...
The searches in the single lepton channel are focused on \TT\ decays and are optimized for two distinctive signatures. One search
...
We will in the following treat in details the two searches for 
