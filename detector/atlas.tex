...
available energy.
Soon enough after the discovery of the muon, 
once no more information could be extracted by cosmic rays observations, 
%after observing all the observable from cosmic rays, 
physicists started to do that using particle accelerators, the most
...
The Forward Calorimeter (FCal) covers the very forward region of pseudorapidity
...
\begin{figure}[tb]\begin{center}
	...
	\caption{(a) Cross section of the barrel muon system. (b) Lateral section of the muon system. 
        ...
        TGCs in magenta, and RPCs in white.%  (From \cite{Aad:JINST})
        }
\end{center}\end{figure}
...
\begin{figure}[tb]\begin{center}
	\subfigure{
  	\includegraphics[width=0.8\textwidth]{detector/figures/extendedbarrel}}
...
Defining the data taking time unit as ``Luminosity Block'' (LB), typically
...
Starting from the RoI, the Level 2 trigger (L2, running on computer farms) will reduce the 75~kHz to
...
The last trigger, Level 3, is also performed on computer farms like L2 and
is referred to as Event Filter (EF).
...
%for the full 2012 dataset of pp collisions at \rts=8~\tev.
The data quality efficiency for the data 
recorded between April and October 2012 (``Period A'' to ``Period G'')
was about 94-95\%\footnote{Data Quality information: \url{https://twiki.cern.ch/twiki/bin/view/AtlasPublic/RunStatsPublicResults2010}.}. 
Finally, a total integrated luminosity of 14.3~\ifb\ 
satisfies data quality and single lepton trigger and is
used for the analyses.

%\begin{figure}[htb]\begin{center}
%	\subfigure{
%  	\includegraphics[width=0.7\textwidth]{detector/figures/DQ-eff-table2012pp-AprilDecember2012}}
...
%\end{center}\end{figure}
%\footnotetext{Data Quality information: \url{https://twiki.cern.ch/twiki/bin/view/AtlasPublic/RunStatsPublicResults2010}}
