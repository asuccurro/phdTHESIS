...
In these studies three different $t\bar{t}$ generators, {\sc MC@NLO}, {\sc PowHeg} and
{\sc Alpgen} were compared. In general, it was found that 
data was bracketed by {\sc MC@NLO} and {\sc PowHeg} predictions,
with {\sc MC@NLO} providing the best description overall, which 
motivated its choice as the main $t\bar{t}$ generator for this analysis. 
In contrast, {\sc Alpgen} was found to be the most inconsistent 
model with data, predicting yields above {\sc PowHeg}, which 
