...
studies where performed in the 7~\tev\ $\TTbar\to WbWb$ analysis
to check the configuration of the statistical analysis giving the
best sensitivity. It was found that the \tight\ selection
shows the best sensitivity and therefore, since we do not expect 
