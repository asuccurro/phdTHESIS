...
\begin{figure}[htb]\begin{center}
	\subfigure[]{\label{fig:GEN_RATIO}
  	\includegraphics[width=0.3\textwidth]{wbx_analysis_14ifb/figures/ttbarModRatio/GEN_RATIO.eps}}
	\subfigure[]{\label{fig:PS_RATIO}
  	\includegraphics[width=0.3\textwidth]{wbx_analysis_14ifb/figures/ttbarModRatio/PS_RATIO.eps}}
	\subfigure[]{\label{fig:FRAG_RATIO}
  	\includegraphics[width=0.3\textwidth]{wbx_analysis_14ifb/figures/ttbarModRatio/FRAG_RATIO.eps}}
