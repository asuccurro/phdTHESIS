...
reports the distributions of the discriminating variables
in the final search channels to be used.
...
are treated in the same way are considered fully 
...
Since in the \htx\ analysis the dominant JES uncertainty eigenvector is the ``JESBREAK1''
(see Section~\ref{sec:htxSYS}) the choice is to correlate the \wbx\ analysis JES 
uncertainty with the ``JESBREAK1'' uncertainty of the \htx\ analysis.
