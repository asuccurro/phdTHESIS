...
\includegraphics[width=.9\textwidth,height=0.5\textheight]{pics/Zee}
...
\begin{frame}\frametitle{Muon}
\footnotesize\centering

\includegraphics[width=.9\textwidth,height=0.5\textheight]{pics/Zmumu}
