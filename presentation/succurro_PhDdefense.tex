...
\begin{itemize}[<+->]
\item {\cccolor \LARGE Why?} {\scriptsize interested with ``new physics''}
\item {\cccolor \LARGE Where?} {\scriptsize is all happening}
\item {\cccolor \LARGE What?} {\scriptsize we observe}
\end{itemize}

\onslide<4->{ and above all
\begin{itemize}
\item {\cccolor \huge How?} {\scriptsize we search through}
\end{itemize}
}
