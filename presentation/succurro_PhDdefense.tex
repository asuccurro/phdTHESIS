...
\begin{itemize}[<+->]
\item {\cccolor \LARGE Why?} {\scriptsize interested in ``new physics''} %{\tiny $\qquad \sim$10\%}%pp.5-25}
\item {\cccolor \LARGE Where?} {\scriptsize it's all happening} %{\tiny $\qquad \sim$10\%}% pp.27-46}
\item {\cccolor \LARGE What?} {\scriptsize we observe} %{\tiny $\qquad \sim$10\%}% pp.47-75}
\end{itemize}
...
\myskip
\begin{itemize}
\item {\cccolor \huge How?} {\small we perform the search} %{\tiny $\qquad \sim$75\%}% pp.79-226} 
\end{itemize}
}
