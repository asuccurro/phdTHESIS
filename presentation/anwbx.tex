...
\item Test statistic: Log-Likelihood Ratio
\end{itemize}
...
$$\cls{s} = \mathbf{\textcolor{red}{\cls{s+b}}/\textcolor{blue}{\cls{b}}}$$
...
\vskip-10ex
\includegraphics[width=0.9\textwidth]{pics/LLRtight_500GeV}\\
\includegraphics[width=0.9\textwidth]{pics/LLRtight_500GeV_log_fill}
