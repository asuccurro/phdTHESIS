...
\begin{figure}[!htb]\centering
	\subfigure[]{\label{fig:MMetaR}
\includegraphics[width=.45\textwidth]{appendices/figures/mujets_mmB/fit_h_lep_eta_muon_real_untagged}}
	\subfigure[]{\label{fig:MMetaF}
\includegraphics[width=.45\textwidth]{appendices/figures/mujets_mmB/fit_h_lep_eta_muon_fake_untagged}}
\caption{Lepton $\eta$ dependency of $\epsilon_\mathrm{real}$ (a) and $\epsilon_\mathrm{fake}$ (b).}\label{fig:etaDep}
\end{figure} 
\begin{figure}[!htb]\centering
        \subfigure[]{\label{fig:MMLJpT}
...
\caption{Parametrization of $\epsilon_\mathrm{fake}$ as a function of the leading jet $p_T$ (a) and of the minimum $\Delta R$ between muon and jets (b). }\label{fig:ljptmindrDep}
\end{figure} 
