...
%        \resizebox{1.\textwidth}{!}{
        \input{vlq_analysis/tables/LatexTable_yields_ELE_noEff.tex}
%}
...
\begin{table}[htb]\centering
%        \resizebox{1.\textwidth}{!}{
        \input{vlq_analysis/tables/LatexTable_yields_MUON_noEff.tex}
%}
...
\section{Comparison between data and prediction vetoing \bjet s}
...
\input{appendices/datamc_1tagin}
