...
\resizebox{1.\textwidth}{!}{
        \input{wbx_analysis_14ifb/cftab/LatexTable_cutflow_ELE_noEff.tex}}
        \caption{
...
\begin{table}[h!tb]\centering
\resizebox{1.\textwidth}{!}{
        \input{wbx_analysis_14ifb/cftab/LatexTable_cutflow_MUON_noEff.tex}}
...
\vskip-1cm
	\subfigure[]{\label{fig:mrecoSR1}
  	\includegraphics[width=0.35\textwidth]{wbx_analysis_14ifb/figures/THESIS_c6_cutflow/VLQAna_WbX_1W_MWb_4_ELEMUON_cutflow1_NOMINAL.eps}}
	\subfigure[]{\label{fig:mrecoSR2}
  	\includegraphics[width=0.35\textwidth]{wbx_analysis_14ifb/figures/THESIS_c6_cutflow/VLQAna_WbX_1W_MWb_4_ELEMUON_cutflow12_NOMINAL.eps}}
	\subfigure[]{\label{fig:mrecoSR3}
  	\includegraphics[width=0.35\textwidth]{wbx_analysis_14ifb/figures/THESIS_c6_cutflow/VLQAna_WbX_1W_MWb_4_ELEMUON_cutflow123_NOMINAL.eps}}
	\subfigure[]{\label{fig:mrecoSR4}
  	\includegraphics[width=0.35\textwidth]{wbx_analysis_14ifb/figures/THESIS_c6_cutflow/VLQAna_WbX_1W_MWb_4_ELEMUON_cutflow1234_NOMINAL.eps}}
